...
class NeihanDuanziPage extends StatefulWidget {
  @override
  _NeihanDuanziPageState createState() => _NeihanDuanziPageState();
}

class _NeihanDuanziPageState extends State<NeihanDuanziPage> {
  ...
  void initState() {
    super.initState();
    _futureImageUrl = fetchNeihanDuanziImageUrl();
  }
